...
WORK_DIR = os.environ.get('DJANGO_WORKDIR')
...
MIGRATION_MODULES = {
    'myshop': 'myshop.migrations.bombay'
}
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(WORK_DIR, 'bombay', 'db.sqlite3'),
    }
}
...
MEDIA_ROOT = os.getenv('DJANGO_MEDIA_ROOT', os.path.join(WORK_DIR, 'media'))
...
FIXTURE_DIRS = [os.path.join(WORK_DIR, 'bombay', 'fixtures')]
